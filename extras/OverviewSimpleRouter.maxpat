...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 130.5, 272.0, 582.0, 189.89828571428572 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 130.5, 208.472285714285704, 582.0, 60.0 ],
									"text" : "Once you have organised access to a MQTT-Broker, you can open the busManager patch, enter the configuration parameters and connect. This patch needs to be running as long as you want to use the bus.\n\nImportant to know: The MQTT-Broker and the busManager don't need to be running on the same machine."
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 252.0, 286.0, 100.0, 48.364648573416844 ],
									"pic" : "SimpleRouter.jpg",
									"presentation" : 1,
									"presentation_rect" : [ 132.5, 156.0, 579.0, 280.031315240083529 ]
								}

							}
, 							{
								"box" : 								{
									"args" : [ "SimpleRouter-Network" ],
									"bgmode" : 0,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 							{
								"box" : 								{
									...
									"text" : "A SimpleRouter consists of two applications: a MQTT-Broker and the busManager.  "
								}
