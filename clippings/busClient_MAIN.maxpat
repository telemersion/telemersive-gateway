...
,
					"patching_rect" : [ 1.0, 1.5, 79.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "tg.BusClient.maxpat",
					"numinlets" : 1,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1.0, 29.0, 681.0, 47.0 ],
...
, 			{
				"name" : "tg.BusClient.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/telemersive-gateway/patchers/tools",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
