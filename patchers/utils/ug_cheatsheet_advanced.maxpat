...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.0, 108.0, 330.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 237.0, 92.0, 173.0, 20.0 ],
					"text" : "encrypt both video and audio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.5, 107.0, 157.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 73.0, 92.0, 157.0, 22.0 ],
					"text" : "--encryption <key_material>"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 609.0, 9.0, 140.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.0, 33.0, 179.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 237.0, 33.0, 179.0, 20.0 ],
					"text" : "export video sent from UltraGrid"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 158.0, 40.0, 107.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.0, 33.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 68.0, 330.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 237.0, 63.0, 143.0, 20.0 ],
					"text" : "send to a remote location"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.0, 68.0, 120.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 110.0, 63.0, 120.0, 22.0 ],
					"text" : "--playback <filepath>"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.0, 224.0, 163.0, 22.0 ],
					"text" : "r help_cheatsheet_advanced"
				}
